<?php
// packages.php - Client Service Packages
session_start();
error_reporting(0);
...
// ===== SERVICE LIMITS FROM ACTIVE PACKAGE =====
...
if (isset($_POST['ajax_action'])) {
    ...
    if ($_POST['ajax_action'] === 'switch_package') {
...
<body>
    ...
    <header>
        <div class="header-inner">
            ...
            <nav class="desktop-nav">
                ...
                <a href="packages.php" class="nav-link active"><i class="fas fa-credit-card"></i> Packages</a>
    ...
    <nav class="mobile-nav" id="mobileNav">
        ...
        <div class="mobile-links">
            ...
            <a href="packages.php" class="active" onclick="closeMobileMenu()"><i class="fas fa-credit-card"></i> Service Packages</a>
    ...
    <div class="main-layout">
        ...
        <aside class="sidebar <?php echo $isCollapsed ? 'collapsed' : ''; ?>" id="mainSidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="packages.php" class="sidebar-link active"><i class="fas fa-credit-card"></i><span class="sidebar-text">Service Packages</span></a>
        ...
        <div class="content">
            ...
            <div class="banner">
                <div>
                    <h2><i class="fas fa-credit-card"></i> Service Packages</h2>
                    <p>Your assigned packages &bull; Active: <strong><?php echo $package_name; ?></strong> (<?php echo number_format($package_price); ?> <?php echo $package_currency; ?>/mo)</p>
                </div>
                <div class="banner-actions">
                    <span class="badge"><i class="fas fa-circle" style="color:#4ade80;font-size:8px;"></i> <?php echo count($packages); ?> Packages</span>
                </div>
            </div>
