...
if (isset($_POST['ajax_action'])) {
    ...
    // ===== DOWNLOAD ATTACHMENT (resolve filename for the front-end) =====
...
<body>
    ...
    <nav class="mobile-nav" id="mobileNav">
        ...
        <div class="mobile-links">
            ...
            <a href="services-packages.php" class="active" onclick="closeMobileMenu()"><i class="fas fa-file-invoice"></i> Service Packages</a>
        </div>
    ...
    <div class="main-layout">
        ...
        <aside class="sidebar <?php echo $isCollapsed ? 'collapsed' : ''; ?>" id="mainSidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="pm-billing.php" class="sidebar-link active"><i class="fas fa-file-invoice"></i><span class="sidebar-text">Billing Management</span></a>
                <a href="services-packages.php" class="active" onclick="closeMobileMenu()"><i class="fas fa-file-invoice"></i> Service Packages</a>
            </nav>
    ...
    <script>
        ...
        function downloadAttachment(invoiceId) {
            ...
            .then(data => {
                if (data.success) {
                    window.location.href = 'download_invoice.php?file=' + encodeURIComponent(data.file);
                } else {
