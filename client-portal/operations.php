<?php
// operations.php - Operations Desk
session_start();
error_reporting(0);
...
// ===== GET SELECTED CLIENT FOR ATTACHMENTS =====
...
<head>
    ...
    <title>PM Portal | HIFI Marketing - Operations</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .mobile-menu-toggle {
            ...
            padding: 4px; flex-direction: column; gap: 5px; z-index: 110;
        }
        ...
        .mobile-nav {
            ...
            background: var(--card-bg); box-shadow: -4px 0 30px rgba(0,0,0,0.1);
            z-index: 160; padding: 20px 24px; transition: right 0.3s cubic-bezier(0.4, 0, 0.2, 1);
        ...
        .modal {
            background: var(--card-bg); border-radius: var(--radius); max-width: 460px;
...
<body>
    ...
    <header>
        <div class="header-inner">
            ...
            <nav class="desktop-nav">
                <a href="operations.php" class="nav-link active"><i class="fas fa-tachometer-alt"></i> Operations</a>
    ...
    <nav class="mobile-nav" id="mobileNav">
        ...
        <div class="mobile-links">
            <a href="operations.php" class="active" onclick="closeMobileMenu()"><i class="fas fa-tachometer-alt"></i> Operations Desk</a>
            ...
            <a href="finance-portal.php" onclick="closeMobileMenu()"><i class="fa-solid fa-chart-line"></i> Finance Portal</a>
        </div>
    ...
    <div class="main-layout">
        ...
        <aside class="sidebar <?php echo $isCollapsed ? 'collapsed' : ''; ?>" id="mainSidebar">
            ...
            <nav class="sidebar-nav">
                <a href="operations.php" class="sidebar-link active"><i class="fas fa-tachometer-alt"></i><span class="sidebar-text">Operations Desk</span></a>
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div style="margin-bottom:12px;">
                    ...
                    <select id="attachment-client-select" onchange="window.location.href='operations.php?client_id=' + this.value" style="width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:8px;background:#f8fafc;font-size:13px;">
