...
$paidAmount = array_sum(array_filter(array_column($invoices, 'amount', 'status'), function($k) { return $k === 'paid'; }, ARRAY_FILTER_USE_KEY));
?>

<!-- Same HTML structure with invoices content -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>HIFI | My Invoices</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .invoice-table th { text-align: left; padding: 10px 8px; font-size: 12px; font-weight: 600; color: #4a5260; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 2px solid #e9edf2; }
        .invoice-table td { padding: 12px 8px; font-size: 14px; color: #1a1c26; border-bottom: 1px solid #f0f3f8; }
        .invoice-table tr:last-child td { border-bottom: none; }
        .invoice-status { padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; }
        .invoice-status.paid { background: #dcfce7; color: #22c55e; }
        .invoice-status.sent { background: #dbeafe; color: #4a5cf5; }
        .invoice-status.draft { background: #f1f5f9; color: #4a5260; }
        .invoice-status.overdue { background: #fecaca; color: #ef4444; }
        ...
        body.dark-mode .invoice-table th { color: #b0b8c5; border-bottom-color: #1e242c; }
        body.dark-mode .invoice-table td { color: #eaeef2; border-bottom-color: #1e242c; }
    ...
    <div class="portal-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="nav-section">
                ...
                <a href="invoices.php" class="nav-item active"><i class="fas fa-file-invoice"></i> Invoices <span class="badge"><?php echo count($invoices); ?></span></a>
            </div>
            <div class="nav-section">
        ...
        <main class="main-content">
            ...
            <div class="stats-mini">
                ...
                <div class="stat-mini">
                    <div class="num">$<?php echo number_format($totalAmount, 2); ?></div>
                    <div class="label">Total Amount</div>
                </div>
                <div class="stat-mini">
                    <div class="num">$<?php echo number_format($paidAmount, 2); ?></div>
                    <div class="label">Paid</div>
                </div>
                <div class="stat-mini">
                    <div class="num"><?php echo count(array_filter($invoices, function($i) { return $i['status'] === 'overdue'; })); ?></div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-file-invoice" style="color:#4a5cf5;margin-right:8px;"></i> All Invoices</h3>
                </div>
                ...
                <table class="invoice-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="invoice-status <?php echo $invoice['status']; ?>"><?php echo ucfirst($invoice['status']); ?></span></td>
