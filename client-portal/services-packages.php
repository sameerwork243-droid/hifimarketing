    ...
    <div class="main-layout">
        <aside class="sidebar <?php echo $isCollapsed ? 'collapsed' : ''; ?>" id="mainSidebar">
            ...
            <nav class="sidebar-nav">
                <a href="pm-portal.php?tab=operations" class="sidebar-link"><i class="fas fa-tachometer-alt"></i><span class="sidebar-text">Operations Desk</span></a>
                <a href="pm-portal.php?tab=deliverables" class="sidebar-link"><i class="fas fa-check-square"></i><span class="sidebar-text">Manage Deliverables</span></a>
                <a href="pm-portal.php?tab=tickets" class="sidebar-link"><i class="fas fa-headset"></i><span class="sidebar-text">Client Tickets & Tasks</span></a>
                <a href="pm-portal.php?tab=verbal" class="sidebar-link"><i class="fas fa-phone"></i><span class="sidebar-text">Client Verbal Requests</span></a>
                ...
                <a href="services-packages.php" class="sidebar-link">
        ...
        <div class="content">
            <div class="banner">
                ...
                <div class="banner-actions">
                    <a href="index.php" class="back-link"><i class="fas fa-arrow-left"></i> Back to PM Portal</a>
