...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .doc-item { display: flex; align-items: center; gap: 14px; padding: 14px 0; border-bottom: 1px solid #f0f3f8; }
        .doc-item:last-child { border-bottom: none; }
        .doc-item .doc-icon { font-size: 32px; color: #4a5cf5; width: 48px; text-align: center; }
        .doc-item .doc-info { flex: 1; }
        .doc-item .doc-info h4 { font-size: 15px; font-weight: 600; color: #1a1c26; }
        .doc-item .doc-info p { font-size: 13px; color: #4a5260; }
        .doc-item .doc-meta { font-size: 12px; color: #4a5260; }
        .doc-item .doc-download { color: #4a5cf5; font-size: 18px; transition: 0.3s ease; cursor: pointer; padding: 8px 12px; border-radius: 8px; }
        .doc-item .doc-download:hover { background: #f0f3f8; color: #3a4be0; }
        ...
        body.dark-mode .doc-item { border-bottom-color: #1e242c; }
        body.dark-mode .doc-item .doc-info h4 { color: #eaeef2; }
        body.dark-mode .doc-item .doc-info p { color: #b0b8c5; }
        body.dark-mode .doc-item .doc-download:hover { background: #1e242c; }
    ...
    <div class="portal-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="nav-section">
                ...
                <a href="documents.php" class="nav-item active"><i class="fas fa-folder-open"></i> Documents <span class="badge"><?php echo count($documents); ?></span></a>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div>
                    ...
                    <p>Access all your project documents</p>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-folder" style="color:#4a5cf5;margin-right:8px;"></i> All Documents</h3>
                    <span style="font-size:13px;color:#4a5260;">Total: <?php echo count($documents); ?></span>
                </div>
                <?php if (count($documents) > 0): ?>
                    ...
                    <div class="doc-item">
                        ...
                        <div class="doc-info">
                            ...
                            <p><?php echo htmlspecialchars($doc['document_type'] ?? 'General Document'); ?></p>
                        </div>
                        <div class="doc-meta">
                            <?php echo date('M d, Y', strtotime($doc['created_at'])); ?>
                        </div>
                        <a class="doc-download" onclick="alert('Downloading: <?php echo htmlspecialchars($doc['document_name']); ?>')"><i class="fas fa-download"></i></a>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
