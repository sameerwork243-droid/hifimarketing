        ...
        if ($campaign_id > 0 && $client_id > 0) {
            ...
            if ($campaign) {
                ...
                $html_output .= '<div class="footer">
                    <p>This report is automatically generated by HIFI Marketing Admin Portal.</p>
...
<head>
    ...
    <title>Ad Campaigns Management | Admin Portal</title>
    ...
    <header>
        <div class="header-inner">
            ...
            <div class="header-right">
                <a href="index.php" class="nav-link"><i class="fas fa-arrow-left"></i> Back to Admin</a>
