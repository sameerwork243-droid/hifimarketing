...
<body>
    <header>
        <div class="header-inner">
            <div class="logo"><div class="brand-icon">A</div> HIFI <span>Marketing</span></div>
    ...
    <div class="main-layout">
        <aside class="sidebar <?php echo $isCollapsed ? 'collapsed' : ''; ?>" id="mainSidebar">
            <div class="sidebar-brand">
                ...
                <div class="sidebar-brand-text"><h1>SMMA Scale</h1><span>Admin Portal</span></div>
            </div>
            <div class="sidebar-toggle"><button onclick="toggleSidebar()"><i class="fas fa-chevron-left"></i></button></div>
            <div class="sidebar-badge"><span>Access</span><span class="role">Admin</span></div>
        ...
        <div class="content">
            <div class="banner">
                ...
                <div class="banner-actions">
                    <a href="index.php" class="back-link"><i class="fas fa-arrow-left"></i> Back to Admin Portal</a>
