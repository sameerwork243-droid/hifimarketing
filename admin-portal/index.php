<?php
// pm-portal.php - Complete PM Portal (FIXED - Navigation + Brand2Social Working)
session_start();
...
// Allow PM, Admin, AND Super Admin
...
// ----------------------------------------------------------------------
// FIX #1: Whitelist the tab value.
// ----------------------------------------------------------------------
$valid_tabs = ['operations', 'deliverables', 'tickets', 'verbal', 'sync'];
$activeTab = (isset($_GET['tab']) && in_array($_GET['tab'], $valid_tabs, true))
    ? $_GET['tab']
    : 'operations';
...
if (isset($_POST['ajax_action'])) {
    ...
    // 12. GET ATTACHMENTS FOR CLIENT (AJAX - for dynamic loading)
    elseif ($_POST['ajax_action'] === 'get_client_attachments') {
        $client_id = intval($_POST['client_id']);
        $attachments = [];
        ...
        $response = ['success' => true, 'attachments' => $attachments];
        echo json_encode($response);
        exit();
    }
...
<header>
    <div class="header-inner">
        ...
        <nav class="desktop-nav">
            <a href="index.php" class="nav-link <?php echo $activeTab === 'operations' ? 'active' : ''; ?>">
                <i class="fas fa-tachometer-alt"></i> Operations
            </a>
            <a href="deliverables.php" class="nav-link <?php echo $activeTab === 'deliverables' ? 'active' : ''; ?>">
                <i class="fas fa-check-square"></i> Deliverables
            </a>
            <a href="tickets.php" class="nav-link <?php echo $activeTab === 'tickets' ? 'active' : ''; ?>">
                <i class="fas fa-headset"></i> Tickets
            </a>
            <a href="verbal.php" class="nav-link <?php echo $activeTab === 'verbal' ? 'active' : ''; ?>">
                <i class="fas fa-phone"></i> Verbal
            </a>
            <a href="progress-sync.php" class="nav-link <?php echo $activeTab === 'sync' ? 'active' : ''; ?>">
                <i class="fas fa-sliders-h"></i> Sync
            </a>
            <a href="pm-billing.php" class="nav-link <?php echo $current_page === 'pm-billing.php' ? 'active' : ''; ?>">
...
<nav class="mobile-nav" id="mobileNav">
    ...
    <div class="mobile-links">
        <a href="index.php" class="<?php echo $activeTab === 'operations' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
            <i class="fas fa-tachometer-alt"></i> Operations Desk
        </a>
        <a href="deliverables.php" class="<?php echo $activeTab === 'deliverables' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
            <i class="fas fa-check-square"></i> Manage Deliverables
        </a>
        <a href="tickets.php" class="<?php echo $activeTab === 'tickets' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
            <i class="fas fa-headset"></i> Client Tickets & Tasks
        </a>
        <a href="verbal.php" class="<?php echo $activeTab === 'verbal' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
            <i class="fas fa-phone"></i> Client Verbal Requests
        </a>
        <a href="progress-sync.php" class="<?php echo $activeTab === 'sync' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
            <i class="fas fa-sliders-h"></i> Progress Counter Sync
        </a>
        <a href="pm-ad-campaigns.php" class="<?php echo $current_page === 'pm-ad-campaigns.php' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
            <i class="fas fa-bullhorn"></i> Ad Campaigns
        </a>
        <a href="service-packages.php" class="<?php echo $current_page === 'service-packages.php' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
            <i class="fas fa-boxes"></i> Service Packages
        </a>
        <a href="pm-billing.php" class="<?php echo $current_page === 'pm-billing.php' ? 'active' : ''; ?>" onclick="closeMobileMenu()">
...
<div class="main-layout">
    ...
    <aside class="sidebar <?php echo $isCollapsed ? 'collapsed' : ''; ?>" id="mainSidebar">
        ...
        <nav class="sidebar-nav">
            <a href="index.php" class="sidebar-link <?php echo $activeTab === 'operations' ? 'active' : ''; ?>">
                <i class="fas fa-tachometer-alt"></i>
                <span class="sidebar-text">Operations Desk</span>
            </a>
            <a href="deliverables.php" class="sidebar-link <?php echo $activeTab === 'deliverables' ? 'active' : ''; ?>">
                <i class="fas fa-check-square"></i>
                <span class="sidebar-text">Manage Deliverables</span>
            </a>
            <a href="tickets.php" class="sidebar-link <?php echo $activeTab === 'tickets' ? 'active' : ''; ?>">
                <i class="fas fa-headset"></i>
                <span class="sidebar-text">Client Tickets & Tasks</span>
            </a>
            <a href="verbal.php" class="sidebar-link <?php echo $activeTab === 'verbal' ? 'active' : ''; ?>">
                <i class="fas fa-phone"></i>
                <span class="sidebar-text">Client Verbal Requests</span>
            </a>
            <a href="progress-sync.php" class="sidebar-link <?php echo $activeTab === 'sync' ? 'active' : ''; ?>">
            ...
            <a href="pm-billing.php" class="sidebar-link <?php echo $current_page === 'pm-billing.php' ? 'active' : ''; ?>">
                <i class="fas fa-credit-card"></i>
                <span class="sidebar-text">Billing Management</span>
            </a>
            <a href="https://hifimarketing.co/admin-portal/reel-analytics/" class="sidebar-link <?php echo $current_page === 'pm-billing.php' ? 'active' : ''; ?>">
                <i class="fas fa-chart-line"></i>
                <span class="sidebar-text">Reel Analyzer</span>
            </a>
        </nav>
    ...
    <div class="content">
        ...
        <!-- ===== BRAND2SOCIAL ATTACHMENTS (PM SIDE) - FIXED WITH AJAX ===== -->
        <div class="card">
            ...
            <!-- Client Selector for Attachments - with AJAX onchange -->
            <div style="margin-bottom:12px;">
                ...
                <select id="attachment-client-select" onchange="loadClientAttachments(this.value)" style="width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:8px;background:#f8fafc;font-size:13px;">
            ...
            <!-- Attachment list container - dynamically updated via AJAX -->
            <div id="pm-attachments-list">
                <?php if (!empty($pm_attachments)): ?>
                    <?php foreach ($pm_attachments as $att): ?>
                    <div class="attachment-item" id="att-<?php echo $att['id']; ?>">
                        <div class="file-info">
                            <div class="file-name">
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="empty-state" id="empty-attachments" style="padding:20px;text-align:center;color:var(--text-muted);">
...
<!-- ===== BRAND UPLOAD MODAL (PM SIDE - MOBILE FIXED) ===== -->
        ...
        <form id="upload-brand-form" onsubmit="uploadBrandFile(event)" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-bottom:12px;">
                ...
                <div style="position:relative;overflow:hidden;display:inline-block;width:100%;">
                    <button type="button" onclick="document.getElementById('brand-upload-file').click();" 
                            style="width:100%;padding:12px 14px;background:#f0f3ff;border:2px dashed var(--border);border-radius:8px;color:var(--primary);font-weight:600;font-size:13px;cursor:pointer;transition:var(--transition);">
                        <i class="fas fa-cloud-upload-alt"></i> Choose File
                    </button>
                    <input type="file" id="brand-upload-file" name="brand-upload-file" 
                           required accept=".pdf,.csv,.xlsx,.xls" 
                           style="position:absolute;left:0;top:0;opacity:0;width:100%;height:100%;cursor:pointer;">
                </div>
                <div id="file-name-display" style="font-size:11px;color:var(--text-muted);margin-top:4px;padding:6px 10px;background:#f8fafc;border-radius:4px;transition:var(--transition);">
                    No file selected
                </div>
            </div>
...
<script>
    ...
    // ===== 14. LOAD CLIENT ATTACHMENTS VIA AJAX (NEW) =====
    function loadClientAttachments(clientId) {
        const container = document.getElementById('pm-attachments-list');
        
        if (!clientId) {
            container.innerHTML = `
                <div class="empty-state" style="padding:20px;text-align:center;color:var(--text-muted);">
                    <i class="fas fa-file" style="font-size:28px;display:block;margin-bottom:6px;opacity:0.3;"></i>
                    <p style="font-size:12px;">Please select a client to view attachments.</p>
                </div>
            `;
            return;
        }
        ...
        container.innerHTML = `
            <div style="padding:20px;text-align:center;color:var(--text-muted);">
                ...
                <p style="font-size:12px;">Loading attachments...</p>
            </div>
        `;

        const formData = new FormData();
        formData.append('ajax_action', 'get_client_attachments');
        formData.append('client_id', clientId);
        ...
        .then(data => {
            if (data.success && data.attachments.length > 0) {
                ...
                data.attachments.forEach(att => {
                    const fileSize = (att.file_size / 1024).toFixed(1);
                    ...
                    html += `
                        <div class="attachment-item" id="att-${att.id}">
                            <div class="file-info">
                                <div class="file-name">
                                    <i class="fas fa-file"></i> ${escapeHtml(att.file_name)}
                                </div>
                                <div class="file-meta">
                                    Uploaded: ${dateStr} ${timeStr} &bull;
                                    Size: ${fileSize} KB
                                    ${att.description ? `&bull; ${escapeHtml(att.description)}` : ''}
                                </div>
                                <div style="font-size:10px;color:var(--text-muted);margin-top:2px;">
                                    <i class="fas fa-user"></i> Uploaded by: ${att.uploaded_by || 'PM'}
                                </div>
                            </div>
                            <div class="file-actions">
                                <button class="btn-download" onclick="downloadFile(${att.id})" title="Download">
                                    <i class="fas fa-download"></i>
                                </button>
                                <button class="btn-delete" onclick="deleteAttachment(${att.id})" title="Delete">
                                    <i class="fas fa-trash"></i>
                                </button>
                            </div>
                        </div>
                ...
                container.innerHTML = `
                    <div class="empty-state" style="padding:20px;text-align:center;color:var(--text-muted);">
                        <i class="fas fa-file" style="font-size:28px;display:block;margin-bottom:6px;opacity:0.3;"></i>
                        <p style="font-size:12px;">No attachments uploaded for this client.</p>
                        <p style="font-size:11px;">Upload brand2social files using the "Upload" button above.</p>
                    </div>
                `;
            }
        })
        .catch(error => {
            ...
            container.innerHTML = `
                <div class="empty-state" style="padding:20px;text-align:center;color:#dc3545;">
                    <i class="fas fa-exclamation-circle" style="font-size:28px;display:block;margin-bottom:6px;"></i>
                    <p style="font-size:12px;">Error loading attachments. Please try again.</p>
                </div>
            `;
        });
    }
    ...
    // ===== 15. UPLOAD BRAND FILE (PM SIDE - FIXED) =====
    function uploadBrandFile(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                // Reload attachments for the current client
                const select = document.getElementById('attachment-client-select');
                if (select.value) {
                    loadClientAttachments(select.value);
                }
            } else {
                showToast('Error: ' + data.message, 'error');
            }
    ...
    function deleteAttachment(docId) {
        ...
        .then(data => {
            if (data.success) {
                ...
                // Remove from DOM
                const el = document.getElementById('att-' + docId);
                if (el) el.remove();
                // Check if any attachments left
                const remaining = document.querySelectorAll('#pm-attachments-list .attachment-item');
                if (remaining.length === 0) {
                    document.getElementById('pm-attachments-list').innerHTML = `
                        <div class="empty-state" style="padding:20px;text-align:center;color:var(--text-muted);">
                            <i class="fas fa-file" style="font-size:28px;display:block;margin-bottom:6px;opacity:0.3;"></i>
                            <p style="font-size:12px;">No attachments uploaded for this client.</p>
                            <p style="font-size:11px;">Upload brand2social files using the "Upload" button above.</p>
    ...
    // ===== AUTO-LOAD ATTACHMENTS IF CLIENT PRESELECTED =====
